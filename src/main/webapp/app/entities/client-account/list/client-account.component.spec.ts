...
describe('ClientAccount Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'client-account', component: ClientAccountComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.clientAccounts?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to clientAccountService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getClientAccountIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getClientAccountIdentifier).toHaveBeenCalledWith(entity);
